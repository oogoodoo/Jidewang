...
span3.innerText=drr[1];
span4.innerText=a.sell*drr[1];
var tnd=a.sell*drr[1]
...
//点击结算判断
   inputrad[7].onclick=function(){
   	if( inputrad[4].checked==true){alert("正在跳转支付页面，请勿关闭");alert("￥"+xnd+"元支付成功！点击去查看");location.href="07UserPage.html?pid=";}
   	else if(inputrad[5].checked==true){alert("正在跳转支付页面，请勿关闭");alert("￥"+xnd+"元支付成功！点击去查看");location.href="07UserPage.html?pid=";}
   	else if(inputrad[6].checked==true){alert("正在跳转支付页面，请勿关闭");alert("￥"+xnd+"元支付成功！点击去查看");location.href="07UserPage.html?pid=";}
   	else{alert("请选择付款方式");}
   }
